...
// //                     // Resale Tickets List - Now using Provider data
...
// //     // final language = ticket?.language ?? 'Telugu';
// //     // final format = ticket?.format ?? '3D';
// //     final showDateTime = ticket?.showDate ?? '4 Aug 8:30 PM';
...
//                         // FIXED: Using Column instead of ListView.builder to avoid infinite height issue
//                         return Padding(
//                           padding: const EdgeInsets.symmetric(horizontal: 16.0),
//                           child: Column(
//                             children: provider.tickets.map((ticket) {
//                               return _buildResaleTicketCard(ticket);
//                             }).toList(),
//                           ),
//                         );
...
//     return GestureDetector(
//       onTap: () {
//         Navigator.push(context, MaterialPageRoute(builder: (context)=>DetailScreen(ticketId: ticket!.id,)));
//       },
//       child: Container(
//         margin: const EdgeInsets.only(bottom: 12),
//         padding: const EdgeInsets.all(12),
