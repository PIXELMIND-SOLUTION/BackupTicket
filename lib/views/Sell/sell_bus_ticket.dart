...
// //                     : ''),
// //                   const SizedBox(height: 16),
// //                   _buildDropdownField('Ticket Type', 'Select', ['A/C Sleeper', 'A/C Seater', 'Non A/C Sleeper', 'Non A/C Seater'], _selectedTicketType, (value) {
// //                     setState(() {
// //                       _selectedTicketType = value;
// //                     });
// //                   }, required: true),
// //                   const SizedBox(height: 16),
// //                   _buildDropdownField('Number of Tickets', '1', ['1', '2', '3', '4', '5', '6'], _selectedTicketCount, (value) {
// //                     setState(() {
...
//       // Convert passenger controllers to PassengerDetail objects
//       List<PassengerDetail> passengersList = _passengerControllers.map((controllers) {
//         return PassengerDetail(
//           name: controllers['name']!.text.trim(),
//           gender: controllers['gender']!.text.trim(),
//           age: int.tryParse(controllers['age']!.text.trim()) ?? 0,
//           seatNumber: controllers['seat']!.text.trim(),
...
//         createdAt: DateTime.now(),
//         ticketImageUrl: null,
//         seatNumbers: passengersList.map((p) => p.seatNumber).toList(),
//       );
...
//                   _buildTextField('Bus Name', 'Enter bus name', _busNameController, required: true),
//                   const SizedBox(height: 16),
//                   _buildTextField('Bus Partner PNR', 'Enter PNR number', _pnrController, required: true),
//                   const SizedBox(height: 16),
//                   _buildTextField('Booking ID', 'Enter booking ID', _bookingIdController, required: true),
//                   const SizedBox(height: 16),
//                   _buildDateField('Date of Journey', _selectedDate != null
//                     ? '${_selectedDate!.day.toString().padLeft(2, '0')}/${_selectedDate!.month.toString().padLeft(2, '0')}/${_selectedDate!.year}'
//                     : '29/01/2024'),
...
//                       _selectedTicketCount = value;
//                       _calculateTotalPrice();
//                       // Update seat count based on number of tickets
//                       _updateSeatCount(int.parse(value!));
//                     });
//                   }, required: true),
//                   const SizedBox(height: 16),
...
//             return SizedBox(
//               width: (MediaQuery.of(context).size.width - 56) / 3, // 3 items per row with spacing
